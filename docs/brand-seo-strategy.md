# 2aBetsy.com — brand & SEO strategy

## Role

**2aBetsy.com** is the official **character / culture / media home** for Betsy AI.
...
- One-liner: *Meet Betsy AI — demand intelligence for the 2A web.*
...
Static **Astro** site → **GitHub Pages**. Custom domain `2abetsy.com` via `public/CNAME`.
